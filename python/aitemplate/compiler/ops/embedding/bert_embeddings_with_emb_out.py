"""
Modified version of bert embeddings that also output the embedding output before layernorm as well
"""
from .... import backend
...
class bert_embeddings_with_emb(Operator):
    """Construct the embeddings from word, position and token_type embeddings."""

    def __init__(self) -> None:
        super().__init__()
        self._attrs["op"] = "bert_embeddings_with_emb"
    ...
    def __call__(
        ...
        emb_output = Tensor(output_shape, src_ops={self})
        self._attrs["outputs"] = [output, emb_output]
